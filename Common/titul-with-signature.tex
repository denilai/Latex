...
\begin{tabular}{lp{0.4\linewidth}p{0.2\linewidth}l}
	\textbf{Выполнил:} & студент группы ИВБО-02-19 & \includegraphics[width=\linewidth]{\pathToCommonFolder/signature} &\studentfio\\ \\%А.~М.~Сосунов\\%К.~Ю.~Денисов\\%И.~А.~Кремнев
	\textbf{Принял:} & \multicolumn{2}{l}{\rang} & \hfill \teacherfio\\
\end{tabular}
\end{table}
\end{center}
