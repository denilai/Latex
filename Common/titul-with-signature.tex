...
\small
\begin{table}[h!]
\begin{tabular}{p{0.14\linewidth}p{0.48\linewidth}p{0.25\linewidth}p{0.2\linewidth}}
	\textbf{Выполнил:} & студент группы ИВБО-02-19 & \studentfio &\includegraphics[width=0.8\linewidth]{\signature}\\ \\
